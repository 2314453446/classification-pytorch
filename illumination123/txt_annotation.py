...
#-------------------------------------------------------#
datasets_path   = r'D:\Learning_software\datasets\classfication-pytorch\illumination123\0605\valid_0605'
...
if __name__ == "__main__":
    for se in sets:
        list_file = open(os.path.join(datasets_path,'cls_' + se + '.txt'), 'w')
