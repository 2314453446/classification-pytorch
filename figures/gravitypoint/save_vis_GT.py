...
# 路径设置
image_folder = r"D:\Learning_software\classification-pytorch\figures\gravitypoint\images"  # 原始图片文件夹路径
output_folder = r"D:\Learning_software\classification-pytorch\figures\gravitypoint\GT_vis"  # 修改后图片保存路径
