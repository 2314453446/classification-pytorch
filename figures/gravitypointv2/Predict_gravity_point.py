...
output_csv = r'D:\Learning_software\classification-pytorch\figures\gravitypointv2\predict_output.csv'
output_folder = r'D:\Learning_software\classification-pytorch\figures\gravitypointv2\images_predict'  # 新的输出文件夹
