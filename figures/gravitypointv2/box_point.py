...
def process_folder(folder_path, output_csv, output_images_folder):
    ...
    with open(output_csv, mode='w', newline='') as file:
        ...
        writer.writerow(['Image', 'X_Ratio', 'Y_Ratio'])
...
folder_path = r'D:\Learning_software\classification-pytorch\figures\gravitypointv2\images'
output_csv = r'D:\Learning_software\classification-pytorch\figures\gravitypointv2\box_point.csv'
output_images_folder = r'D:\Learning_software\classification-pytorch\figures\gravitypointv2\images_box'  # 新的输出图片文件夹路径
