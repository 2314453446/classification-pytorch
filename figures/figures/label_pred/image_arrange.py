...
def combine_images_from_folders(folders, indices, grid_size=(3, 3), gap=10, output_path="./combined_image0.jpg"):
    """
...
# Example usage
folders = [r"D:\Learning_software\classification-pytorch\figures\figures\label_pred\label",
           r"D:\Learning_software\classification-pytorch\figures\figures\label_pred\fack_predict",
           r"D:\Learning_software\classification-pytorch\figures\figures\label_pred\predict"]  # Replace with actual folder paths
indices = [(0,3,6),(0,3,6),(0,3,6)]  # Indices of images to be taken from each folder
