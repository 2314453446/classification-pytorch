...
# 使用示例
source_folder = r'D:\Learning_software\classification-pytorch\figures\figures\label_pred\label'
...
destination_folders = [r'D:\Learning_software\classification-pytorch\figures\figures\label_pred\predict',
